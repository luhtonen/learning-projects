...
<div id="show-user" class="content scaffold-show" role="main">
    ...
    <ol class="property-list user">
        ...
        <g:if test="${userInstance?.userName}">
            <li class="fieldcontain">
                <span id="userName-label" class="property-label"><g:message
                        code="user.userName.label" default="User Name"/></span>
        ...
        <g:if test="${userInstance?.categories}">
            <li class="fieldcontain">
                <span id="categories-label" class="property-label"><g:message
                        code="user.categories.label" default="Categories"/></span>
        ...
        <g:if test="${userInstance?.todos}">
            <li class="fieldcontain">
                <span id="todos-label" class="property-label"><g:message code="user.todos.label"
                                                                         default="Todos"/></span>

                <g:each in="${userInstance.todos}" var="t">
                    <span class="property-value" aria-labelledby="todos-label"><g:link
